...
const projects = [
  {
    ...
    domain: "vingo.com",
    type: "Food Delivery",
    desc: "A full-stack food delivery web application using the MERN stack with features like user authentication, restaurant browsing, online ordering, secure payments, and order tracking.",
    stack: ["React.js", "Express.js", "MongoDB", "OpenStreetMap","RazorPay"],
    url: "https://food-delivery-frontend-tffg.onrender.com/",
    linkLabel: "visit ↗",
  },
  {
    title: "Vybe",
    ...
    domain: "vybe.com",
    type: "Social Media",
    desc: "A full-stack social media web application using the MERN stack with features like user authentication, post creation, likes, comments, and profile management.",
    stack: ["React.js", "Express.js", "Socket.io", "MongoDB"],
    url: "https://vybe-frontend-b8o9.onrender.com",
    linkLabel: "visit ↗",
  },
  {
    title: "ShopNest",
